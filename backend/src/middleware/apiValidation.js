...
module.exports = {
  ...
  adminDashboardStats: validateRequest({
    query: z
      .object({
        dateFrom: z.iso.date().optional(),
        dateTo: z.iso.date().optional(),
  ...
  checkerHistory: validateRequest({ query: z.object({ ...pagination }) }),
  ...
  cashierBookingCreate: validateRequest({
    body: z.object({
      showId: uuid,
      seatIds,
      paymentMethod: z.enum(["payos", "cash"]),
      lockToken: uuid,
    }),
  }),
