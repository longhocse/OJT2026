  ...
  return {
    ...
    theaterAssignments: Array.isArray(raw.theaterAssignments)
      ? raw.theaterAssignments.map((assignment) => {
          const item = object(assignment, "User.theaterAssignment");
          return {
            id: id(item.id, "User.theaterAssignment"),
            role_at_theater: text(item.role_at_theater),
            is_active: item.is_active !== false,
            theater: item.theater
              ? {
                  id: id(item.theater.id, "User.theaterAssignment.theater"),
                  name: text(item.theater.name),
                  address: nullableText(item.theater.address),
                  city: nullableText(item.theater.city),
                  phone: nullableText(item.theater.phone),
                }
              : null,
          };
        })
