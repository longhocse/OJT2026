  ...
  const submitBooking = async ({ paymentMethod: selectedPaymentMethod }) => {
    ...
    try {
      ...
      if (booking.payment?.checkoutUrl) {
        // Ensure the access token is durable before leaving this origin for PayOS.
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <section className="order-1 lg:order-2 lg:col-span-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-[#E6DFD9]">
              ...
              <p className="mt-5 text-sm leading-relaxed text-[#6B625A]">
                MovieTap hiện chỉ hỗ trợ thanh toán trực tuyến bằng PayOS. Sau khi xác nhận, bạn
                sẽ được chuyển sang PayOS/VietQR để hoàn tất thanh toán.
              </p>
