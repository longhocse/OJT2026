...
const AdminShowForm = () => {
  ...
  useEffect(() => {
    if (id || user?.role !== "manager" || availableCinemas.length !== 1 || cinemaId) return;
    setCinemaId(availableCinemas[0].id);
  }, [availableCinemas, cinemaId, id, user?.role]);
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex items-center gap-4 border-b border-white/5 pb-6">
          <button
            type="button"
            aria-label="Quay lại"
            onClick={() => navigate(`${basePath}/shows`)}
