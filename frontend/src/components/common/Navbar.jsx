        ...
        <div className="flex items-center gap-4">
          ...
          {isAuthenticated ? (
            <div className="relative group">
              <button className="w-10 h-10 rounded-full bg-surface-container-high border border-white/10 overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-200">
                <img
            ...
            <Link
              to="/login"
              className="px-4 py-2 bg-primary-container text-on-primary-container rounded-lg font-button text-sm hover:scale-105 transition-transform duration-200"
            >
              Login
            </Link>
          )}
