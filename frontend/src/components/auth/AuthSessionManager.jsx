...
export default function AuthSessionManager() {
  ...
  useEffect(() => {
    ...
    authService
      ...
      .catch(() => {
        // Only an authoritative auth response may destroy a persisted session.
        // Network, tunnel and 5xx failures must not log the user out.
        ...
        authService.getMe().then(
          ...
          (error) => {
            ...
            if (
              tokenRef.current === tokenBeingVerified &&
              [401, 403].includes(status) &&
              !error.sessionVerificationDeferred
            ) {
