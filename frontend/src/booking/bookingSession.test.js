...
test("booking handoff survives a new PayOS browsing context", () => {
  bookingSuccessStore.save({ bookingId: "booking-2" });
  sessionStorage.clear();
  expect(bookingSuccessStore.load()).toEqual({ bookingId: "booking-2" });
});
